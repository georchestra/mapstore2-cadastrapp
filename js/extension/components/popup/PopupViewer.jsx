...
import { bulleInfoSelector, getAuthLevel, loaderSelector} from "@js/extension/selectors/cadastrapp";
...
export default compose(
    ...
    if (isEmpty(infoBulle)) return <div className="popup-container"><Message msgId={"cadastrapp.popup.nodata"} /></div>;
            ...
            <div className="cadastrapp-infobulle-parcelle">
                <table className="info-popup-table">
                    ...
                    <tbody>
                        ...
                        {popupTableData.map(({ label, value, condition = true }) => {
                            return (
                                condition && (
                                    <tr>
                        ...
                        { isAuthenticated && !isEmpty(proprietaires) && proprietaires.map(({ app_nom_usage: owner }) => (
                            <tr>
